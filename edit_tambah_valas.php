...
<html lang="en">
  ...
  <body>
    ...
    <form action="update_tambah_valas.php" method="post" style="padding: 50px;margin: 150px auto;box-shadow: 3px 3px 5px rgba(0,0,0,0.5);" class="bg-light">
            ...
            <div class="row">
                <div class="col-12"><button type="submit" class="btn btn-secondary pl-5 pr-5">Perbaharui</button></div>
            </div>
        </form>
    </div>
